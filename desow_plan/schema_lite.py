...
# Ширина отрезка стены под точкой съёмки, куда гейт проёмы не ставит: знак камеры
# 0.46 dw в ширину плюс запас. Маркер — не объект обмера, но проём, вырезанный
# ровно под ним, на чертеже читается как «дверь через камеру».
CAMERA_KEEPOUT_DW = 0.7
